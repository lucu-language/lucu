...
impl<'a, 'b> Lower<'a, 'b> {
    ...
    fn intrinsic_type(&self, name: &ast::Name) -> Result<Type> {
        ...
        let ty = match (module.as_str(), name.ident.as_str()) {
            ...
            ("builtin:types", "uaddr") => TypeEnum::Integer(Integer::unsigned(IntSize::Address)),
            ("builtin:types", "usize") => TypeEnum::Integer(Integer::unsigned(IntSize::Size)),
            ...
            ("builtin:types", "addr") => TypeEnum::Integer(Integer::signed(IntSize::Address)),
            ("builtin:types", "size") => TypeEnum::Integer(Integer::signed(IntSize::Size)),
